...
#ifndef LORA_NETWORK_TRAILER_H
#define LORA_NETWORK_TRAILER_H
...
namespace ns3 {
	 ...
	 */
	class LoRaNetworkTrailer : public Trailer
	{
		public:
		 ...
		 */
		LoRaNetworkTrailer (void);
		LoRaNetworkTrailer (uint8_t delay, uint8_t rx1Offset, uint8_t rx2Dr, uint32_t rx2Freq);
		~LoRaNetworkTrailer (void);
		...
		/**
			* Gets the delay of the first reception slot
			*
			* \return the delay 
			*/
		uint8_t GetDelay ();
		/**
			* Sets the delay of the first reception slot
			*
		...
		uint8_t m_delay; //!< delay between transmission and first reception slot
	};

} // namespace ns3

#endif /* LORA_NETWORK_TRAILER_H */
