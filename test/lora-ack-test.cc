...
NS_LOG_COMPONENT_DEFINE ("lora-ack-test");

class LoRaAckTestCase : public TestCase
{
public:
  LoRaAckTestCase ();
...
LrWpanAckTestCase::LrWpanAckTestCase ()
  : TestCase ("Test the LoRa ACK handling")
{
...
LrWpanAckTestCase::DoRun (void)
{
  ...
  Ptr<LoRaNetDevice> dev0 = CreateObject<LoRaNetDevice> ();
  Ptr<LoRaNetDevice> dev1 = CreateObject<LoRaNetDevice> ();
...
class LoRaAckTestSuite : public TestSuite
{
public:
  LoRaAckTestSuite ();
};

LoRaAckTestSuite::LoRaAckTestSuite ()
  : TestSuite ("lora-ack", UNIT)
{
  AddTestCase (new LoraAckTestCase, TestCase::QUICK);
}

static LoRaAckTestSuite g_loRaAckTestSuite;
